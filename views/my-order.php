        ...
        <div class="card-body">
            ...
            <div >
                ...
                <div class="float-right">
                    ...
                    <!-- <a href="index.php?url=xoa-don-hang&id=<?=$order_id?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn hủy đơn hàng này?')">Hủy Đơn hàng</a> -->
<?php 
                if ($status == 1) { // Chỉ hiển thị khi đơn hàng chưa xác nhận ?>
                    <a href="index.php?url=xoa-don-hang&id=<?=$order_id?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn hủy đơn hàng này?')">Hủy Đơn hàng</a>
<?php } ?>
                </div>
            </div>
